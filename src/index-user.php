                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="topic-content pull-right">
                                                <h4>
                                                    <a href="<?php echo APPURL; ?>/topics/show-topic-user.php?id=<?php echo $result->id; ?>"><?php echo $result->title; ?></a>
                                                </h4>
                                ...
                                <li class="topic">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="topic-content pull-right">
                                                <h4>
                                                    <a href="<?php echo APPURL; ?>/topics/show-topic-user.php?id=<?php echo $topic->id; ?>"><?php echo $topic->title; ?></a>
                                                </h4>
                                                <div class="topic-info">
